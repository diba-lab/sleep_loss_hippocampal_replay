...
class PositionViewer(BaseMultiChannelViewer):
    ...
    def on_data_ready(
        ...
        # for i, c in enumerate(visibles):
        # self.curves[0].show()
        self.curves[0].setData(dict_curves[0], dict_curves[1])
        # self.curves[0].setData(dict_curves[0][10], dict_curves[1][10])
        ...
        self.scatter.setData(x=x, y=y, brush=np.array([mkCachedBrush("#FFFFFF")]))
        ...
        self.plot.setXRange(10, 200, padding=0.0)
        self.plot.setYRange(-10, 150, padding=0.0)
        # self.plot.setYRange(
